...
STRINGS = {
    'jp': {
        ...
        'stats_last_updated': '統計の最終更新',
        'details_note': '運航会社・機種・航路・国・高度レンジで過去の航空機コンタクトを検索・絞り込みできます。',
        'details_note_passes': '// raw の保存期間（30日）より前 — pass 集計から復元。機体一覧は完全ですが、航跡は残っていません。',
        'details_no_track_short': '航跡なし（raw 保存期間外）',
        ...
        'map_wx_rain': '雨雲',
        'map_wx_wind': '強風',
        'map_wx_wind_note': '地上風・突風の強さを色分け（10kt 以上、数値は視野内の最大／Open-Meteo）',
        'map_low': '低',
        'map_high': '高',
        'map_emerg': '緊急',
        ...
        # 新增 stats：全年日曆 / 紀錄榜 / 速度分佈 / 航向羅盤
        'stats_hdr_calendar': '通年 · 日別アクティビティ (JST)',
        'stats_calendar_months': ['1月','2月','3月','4月','5月','6月','7月','8月','9月','10月','11月','12月'],
        'stats_hdr_records': '記録 · 歴代ベスト',
        'stats_rec_fastest': '最速',
        'stats_rec_longest': '最長滞在',
        'stats_rec_busiest_day': '最繁忙日',
        'stats_rec_most_seen': '最多観測機',
        'stats_hdr_speed': '全DB · 対地速度の分布',
        'stats_hdr_fastest': '最速 TOP 10',
        'stats_speed_unit': 'kt',
        'stats_hdr_compass': '直近7日 · 進行方位 (course)',
        'stats_compass_dir': ['北','北東','東','南東','南','南西','西','北西'],
        'stats_hdr_coverage': '受信範囲 · 方位別の最遠距離 (km)',
        'stats_coverage_note': '直近30日の生データのみ（過去最遠記録ではありません）',
    ...
    'hk': {
        ...
        'stats_last_updated': '統計最後更新',
        'details_note': '可以按航空公司、機型、航線、國家同高度範圍搜尋同篩選歷史飛機接觸記錄。',
        'details_note_passes': '// 早過 raw 保留期（30 日）—— 由 pass 聚合還原。機隊列表齊全，但冇航跡可以睇。',
        'details_no_track_short': '冇航跡（超出 raw 保留期）',
        ...
        'map_wx_rain': '雨雲',
        'map_wx_wind': '大風',
        'map_wx_wind_note': '地面風／陣風強度色階（10kt 起，數字係視野內最大值／Open-Meteo）',
        'map_low': '低',
        'map_high': '高',
        'map_emerg': '緊急',
        ...
        # 新增 stats：全年日曆 / 紀錄榜 / 速度分佈 / 航向羅盤
        'stats_hdr_calendar': '全年 · 每日活躍度 (JST)',
        'stats_calendar_months': ['1月','2月','3月','4月','5月','6月','7月','8月','9月','10月','11月','12月'],
        'stats_hdr_records': '紀錄 · 歷來之最',
        'stats_rec_fastest': '最快',
        'stats_rec_longest': '停留最耐',
        'stats_rec_busiest_day': '最繁忙一日',
        'stats_rec_most_seen': '最常見機',
        'stats_hdr_speed': '全 DB · 對地速度分佈',
        'stats_hdr_fastest': '最快 TOP 10',
        'stats_speed_unit': 'kt',
        'stats_hdr_compass': '近 7 日 · 航向分佈 (course)',
        'stats_compass_dir': ['北','東北','東','東南','南','西南','西','西北'],
        'stats_hdr_coverage': '接收範圍 · 各方位最遠距離 (km)',
        'stats_coverage_note': '只計最近 30 日 raw 資料（唔係歷來最遠紀錄）',
    ...
    'en': {
        ...
        'details_note_passes': '// older than raw retention (30d) — reconstructed from pass aggregates. Aircraft list is complete, but no track data remains.',
        'details_no_track_short': 'no track (past raw retention)',
        ...
        'map_clear': 'CLEAR',
        'map_home': 'RECEIVER (HOME)',
        'map_wx_cloud': 'CLOUD',
        'map_wx_rain': 'RAIN',
        'map_wx_wind': 'WIND',
        'map_wx_wind_note': 'Surface wind/gust strength, shaded from 10 kt (number = max in view, Open-Meteo)',
        'map_low': 'LOW',
        'map_high': 'HIGH',
        'map_emerg': 'EMERGENCY',
        ...
        'lbl_cat': 'Cat',
        'cat_plane': 'Planes',
        'cat_heli': 'Helicopters',
        'cat_glider': 'Gliders',
        'cat_balloon': 'Balloon / Airship',
        'cat_parachute': 'Parachute',
        'cat_ultralight': 'Ultralight',
        'cat_drone': 'Drones',
        'cat_space': 'Space vehicle',
        'cat_ground': 'Ground vehicle',
        ...
        # 新增 stats：全年日曆 / 紀錄榜 / 速度分佈 / 航向羅盤
        'stats_hdr_calendar': 'YEAR · DAILY ACTIVITY (JST)',
        'stats_calendar_months': ['JAN','FEB','MAR','APR','MAY','JUN','JUL','AUG','SEP','OCT','NOV','DEC'],
        'stats_hdr_records': 'RECORDS · ALL-TIME BESTS',
        'stats_rec_fastest': 'FASTEST',
        'stats_rec_longest': 'LONGEST PASS',
        'stats_rec_busiest_day': 'BUSIEST DAY',
        'stats_rec_most_seen': 'MOST SEEN',
        'stats_hdr_speed': 'ALL-DB · GROUND SPEED DISTRIBUTION',
        'stats_hdr_fastest': 'TOP 10 FASTEST',
        'stats_speed_unit': 'kt',
        'stats_hdr_compass': 'LAST 7D · HEADING DISTRIBUTION (COURSE)',
        'stats_compass_dir': ['N','NE','E','SE','S','SW','W','NW'],
        'stats_hdr_coverage': 'RECEIVER RANGE · MAX DISTANCE BY BEARING (KM)',
        'stats_coverage_note': 'Last 30 days of raw data only (not an all-time record)',
