...
STRINGS = {
    'jp': {
        ...
        'map_wx_rain': '雨雲',
        'map_wx_wind': '強風',
        'map_wx_wind_note': '突風 25kt 以上の領域を色分け（Open-Meteo）',
        'map_low': '低',
        'map_high': '高',
        'map_emerg': '緊急',
    ...
    'hk': {
        ...
        'map_wx_rain': '雨雲',
        'map_wx_wind': '大風',
        'map_wx_wind_note': '陣風 25kt 以上嘅範圍先著色（Open-Meteo）',
        'map_low': '低',
        'map_high': '高',
        'map_emerg': '緊急',
    ...
    'en': {
        ...
        'map_wx_rain': 'RAIN',
        'map_wx_wind': 'WIND',
        'map_wx_wind_note': 'Areas with gusts of 25 kt or more (Open-Meteo)',
        'map_low': 'LOW',
        'map_high': 'HIGH',
        'map_emerg': 'EMERGENCY',
